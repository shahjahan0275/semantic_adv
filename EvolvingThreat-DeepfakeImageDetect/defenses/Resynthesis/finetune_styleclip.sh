#!/bin/bash
#SBATCH --job-name=finetune_styleclip               # Job name
...
#SBATCH --output=/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/Resynthesis/logs/finetune_styleclip_%j.log   # STDOUT/STDERR
...
OUTPUT_PATH='/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/Resynthesis/saved_model'
