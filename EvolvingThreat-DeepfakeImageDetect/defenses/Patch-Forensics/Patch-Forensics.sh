#!/encs/bin/tcsh
#SBATCH --job-name=Patch-Forensics                               # Job name
...
#SBATCH --output=/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/Patch-Forensics/logs/Patch-Forensics_train_%j.log
...
# Run training
# ==============================
python3 train.py checkpoints/gp2-faceforensics-df_seed0_xception_block2_constant_p20/opt.yml \
