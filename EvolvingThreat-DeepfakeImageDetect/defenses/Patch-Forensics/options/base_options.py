...
class BaseOptions(options.Options):
    def __init__(self, print_opt=True):
        ...
        #  patch shuffling for input image
        parser.add_argument('--patch_shuffle', action='store_true',help='enable patch shuffling augmentation')
        parser.add_argument('--patch_size', type=int, default=16,help='patch size for patch shuffling')
        parser.add_argument('--patch_shuffle_prob', type=float, default=0.5, help='probability of applying patch shuffling')
