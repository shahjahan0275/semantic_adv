...
def array_from_imgdir(imgdir, grayscale=True, max_samples=None, seed=42):
    """
    Loads images from a directory, center-crops to 512×512, 
    converts to tensor, and scales to [-1, 1] without resizing.
    """
    ...
    # Use center crop transform change it for different size
    ...
    def loader(path):
        ...
        # Crop the image instead of resizing
        img = crop_tf(img)
    ...
    print(f"Loaded {len(array)} cropped images from {imgdir}")
    return array
...
def main(args):
    # ===================== 🔹 STEP 1: Load limited data subsets =====================
