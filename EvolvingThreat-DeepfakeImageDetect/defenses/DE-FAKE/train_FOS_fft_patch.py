...
def compute_patch_fft_stats(img, num_patches=4):
    ...
    Returns per-patch FFT multi-band stats.
    3 bands × 3 channels × 4 stats × (num_patches^2)
    For num_patches=4 → 36 × 16 = 576-dimensional vector
    """
...
# --------------------------------------
# CORRECT: Initialize NEW classifier for 
  #CLIP embedding = 512
  #FFT patch stats = 36 × 16 = 576
  #TOTAL = 512 + 576 = 1088
# --------------------------------------
linear = NeuralNet(
    #input_size=560,
