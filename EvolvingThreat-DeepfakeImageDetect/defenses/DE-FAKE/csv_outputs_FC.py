...
# Dictionary of all splits and labels
DATASETS = {
...
OUTPUT_DIR = "/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/DE-FAKE/csv_outputs"
...
def write_csv(label_name, folder_path):
    """
    Generates a CSV file for the given folder.
    """
    ...
    for root, dirs, files in os.walk(folder_path):
        for file in files:
            ...
            if ext in IMG_EXT:
                ...
                # NEW: Fixed caption for all rows
                caption = "A human face image"
                
                rows.append([full_path, caption])
