...
#fake_test = CustomFakeDataset(datafile="/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/DE-FAKE/csv_outputs/CLIPResNet_test_fake.csv")
#fake_test = CustomFakeDataset(datafile="/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/DE-FAKE/csv_outputs/EfficientNet_test_fake.csv")
fake_test = CustomFakeDataset(datafile="/speed-scratch/a_shahj/EvolvingThreat-DeepfakeImageDetect/defenses/DE-FAKE/csv_outputs/ViT_test_fake.csv")
