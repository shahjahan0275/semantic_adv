...
from models.__init__FOS__ import get_model

from models import clip_models_FOS as clip_models   #For Forth order statistics
...
class Trainer(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if opt.resume_path is not None:
            ...
            checkpoint = torch.load(opt.resume_path, map_location=self.device)
            ...
            if 'optimizer_state_dict' in checkpoint and checkpoint['optimizer_state_dict'] is not None:
                ...
                # 🔥 CRITICAL FIX: move optimizer state tensors to GPU
    ...
    def save_networks(self, name, epoch):
        ...
        torch.save({
            ...
            'epoch': epoch,  # pass the actual epoch number from the loop
